...
ig_rz_SEC.dat   for the time period from Jan 1958 onward. The file is updated 
ig_rz_IPS.dat   quarterly. It is read by subroutine tcon in irifun.for (ASCII). 
                Two files are given to show the difference in IG12 and RZ12 
                predictions (SEC=http://www.sec.noaa.gov/ftpdir/weekly/Predict.txt;
                IPS=http://www.ips.gov.au/pipermail/ips-ssn-predictions/2006-November.txt).
                default: ig_rz.dat = ig_rz_SEC.dat
