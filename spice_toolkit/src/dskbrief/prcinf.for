...
C$ Version
C
C-    DSKBRIEF Version 3.0.0, 02-NOV-2021 (NJB)
C
C        Fixed indentation of the first two lines in HLPTXT.
C
C        Updated version number and date.
C
...
C
      CHARACTER*(*)         VER
      PARAMETER           ( VER = '3.0.0, 02-NOV-2021' )
...
C
         ...
         HLPTXT(  1 ) = '   DSKBRIEF is a command-line utilit'
     .   //             'y program that displays a summary of'
         HLPTXT(  2 ) = '   one or more binary DSK files. The'
     .   //             ' program usage is:'
         HLPTXT(  3 ) = ' '
