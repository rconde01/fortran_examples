C$Procedure ADDCOM ( Add comments to DSK file )
      ...
      SUBROUTINE ADDCOM ( HANDLE, CMDFIL, INPFN,
     .                    OUTFN,  CMTFIL, APPFLG )
      IMPLICIT NONE
...
C$ Version
C
C-    MKDSK Version 3.0.0, 27-OCT-2020 (NJB)
C
C        Increased comment line length from 80 to 255 characters. The
C        change applies to both comment files and comments in setup
C        files.
C
