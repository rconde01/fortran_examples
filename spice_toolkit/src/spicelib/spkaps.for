...
C     relative to an observer specified by its state and 
C     acceleration relative to the solar system barycenter. The 
C     returned state may be optionally corrected for light time 
C     and stellar aberration. All input and output vectors are 
...
C$ Exceptions
C
C     1)  If the value of ABCORR is not recognized, an error is signaled
...
C         barycenter cannot be computed, an error is signaled by a
...
C        C     it references must exist in your current working
C        C     directory.
C        C
C              CHARACTER*(*)         META
C              PARAMETER           ( META   = 'spkaps_ex1.tm' )
C        C
...
C        C        geometric state and acceleration of the observer
C        C        relative to the solar system barycenter at ET,
C        C        expressed relative to the J2000 reference frame. First
C        C        find the state:
C        C
...
C         J2000 x-position (km):     -291584.61369497533
C         J2000 y-position (km):     -266693.40583162551
C         J2000 z-position (km):     -76095.653209237149
C         J2000 x-velocity (km/s):   0.64343915743508395
C         J2000 y-velocity (km/s):  -0.66606587365741410
C         J2000 z-velocity (km/s):  -0.30131006342946742
C         One-way light time (s):     1.3423106103251679
C         Light time rate:            1.0731690869897750E-007
C
C         ET =    3600.0000000000000
C         J2000 x-position (km):     -289256.45942322229
C         J2000 y-position (km):     -269080.60545907740
C         J2000 z-position (km):     -77177.352771302132
C         J2000 x-velocity (km/s):   0.64997032016926526
C         J2000 y-velocity (km/s):  -0.66014825329341664
C         J2000 z-velocity (km/s):  -0.29963041790724715
C         One-way light time (s):     1.3426939548635302
C         Light time rate:            1.0565259895222426E-007
C
C         ET =    7200.0000000000000
C         J2000 x-position (km):     -286904.89654239739
C         J2000 y-position (km):     -271446.41676468350
C         J2000 z-position (km):     -78252.965533623050
C         J2000 x-velocity (km/s):   0.65644388315539315
C         J2000 y-velocity (km/s):  -0.65418355204586442
C         J2000 z-velocity (km/s):  -0.29792853294482308
C         One-way light time (s):     1.3430713117337547
C         Light time rate:            1.0399045689875861E-007
C
C         ET =    10800.000000000000
C         J2000 x-position (km):     -284530.13302756584
C         J2000 y-position (km):     -273790.67111559171
C         J2000 z-position (km):     -79322.411703917489
C         J2000 x-velocity (km/s):   0.66285950473048116
C         J2000 y-velocity (km/s):  -0.64817224685146524
C         J2000 z-velocity (km/s):  -0.29620455846903732
C         One-way light time (s):     1.3434426890693671
C         Light time rate:            1.0233066524342374E-007
C
C         ET =    14400.000000000000
C         J2000 x-position (km):     -282132.37807791750
C         J2000 y-position (km):     -276113.20159697317
C         J2000 z-position (km):     -80385.612030562901
C         J2000 x-velocity (km/s):   0.66921684649247459
C         J2000 y-velocity (km/s):  -0.64211481528028158
C         J2000 z-velocity (km/s):  -0.29445864490384888
C         One-way light time (s):     1.3438080956559786
C         Light time rate:            1.0067340363005083E-007
C
C
C$ Restrictions
C
...
C$ Version
C
C-    SPICELIB Version 1.2.0, 26-OCT-2021 (JDR) (NJB)
C
C        Edited the header to comply with NAIF standard. Updated
C        example's meta-kernel.
C
C        Bug fix: ABCORR now is parsed using ZZVALCOR. This improves
C        error checking. Removed unnecessary in-line error checking
C        now provided by ZZVALCOR.
C
