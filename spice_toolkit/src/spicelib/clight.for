...
C$ Brief_I/O
C
C     The function returns the speed of light in vacuum (km/sec).
C
C$ Detailed_Input
C
C     None.
...
C$ Version
C
C-    SPICELIB Version 1.0.3, 25-AUG-2021 (JDR)
C
C        Edited the header to comply with NAIF standard.
C
C-    SPICELIB Version 1.0.2, 08-JAN-2008 (NJB)
C
C        $Examples section was updated to remove references to SPKAPP
C        and BODMAT.
C
