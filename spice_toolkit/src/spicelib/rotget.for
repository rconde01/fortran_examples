...
C         to .FALSE., OUTFRM will be set to zero and ROTATE will be set
C         to the zero 3x3 matrix.
C
...
C
C        **Updated shadow routines ZZROTGT0 and ZZROTGT1, as must be
...
C
      ...
      ELSE IF ( TYPE .EQ. SWTCH ) THEN
         ...
         CALL ZZSWFXFM ( INFRM, ET, 3, ROTATE, OUTFRM, FOUND )
