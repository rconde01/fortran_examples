...
C     specified point X and return the value of the input expansion at
C     X as well. The constant of integration is selected to make the
C     integral zero when X equals the abscissa value X2S(1).
C
C$ Disclaimer
C
...
C              Chebyshev expansion. The coefficient of the I'th
...
C
C     [2]  "Chebyshev polynomials," Wikipedia, The Free Encyclopedia.
C          Retrieved 01:23, November 23, 2013, from
C          http://en.wikipedia.org/w/index.php?title=
...
C        Corrected error in $Detailed_Input description of CP.
C
C        Fixed range of Chebyshev coefficients of input expansion in
C        the description of argument CP in $Detailed_Input.
C
