...
C$ Exceptions
C
C     1)  If there is an IOSTAT error while opening, reading, or writing
C         a file, the error is signaled by a routine in the call tree of
C         this routine.
C
C     2)  If the text file is not in the correct format, an error is
