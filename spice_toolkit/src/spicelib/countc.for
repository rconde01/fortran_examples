...
C
C     The function returns the number of characters in a group of lines
C     in a text file.
C
C$ Detailed_Input
C
...
C
C     The function returns the number of characters in the group of
C     lines in the text file beginning with BLINE and ending with ELINE.
C     Trailing blanks on a line are not included in the count.
C
C$ Parameters
C
C     None.
...
C         the count, the error SPICE(INVALIDTEXT) is signaled.
C
...
C$ Version
C
C-    SPICELIB Version 1.2.0, 18-MAR-2021 (JDR)
C
