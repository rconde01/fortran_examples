...
C
C     The function returns the number of words in the input string
C     STRING.
C
C$ Detailed_Input
C
C     STRING   is the input string to be parsed. It contains some number
C              of words, where a word is any string of consecutive
C              non-blank characters delimited by a blank or by either
C              end of the string.
C
C$ Detailed_Output
C
C     The function returns the number of words in the input character
C     string STRING.
C
C$ Parameters
C
