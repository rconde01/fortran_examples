...
C         the error SPICE(WRONGCONIC) is signaled.
C
C$ Files
C
C     None.
...
C
C     [2]  E. W. Ng, "A General Algorithm for the Solution of Kepler's
C          Equation for Elliptic Orbits", Cel. Mech. 20, pp.243-249,
C          1979.
C
...
C$ Version
C
C-    SPICELIB Version 1.2.0, 14-APR-2021 (JDR)
C
