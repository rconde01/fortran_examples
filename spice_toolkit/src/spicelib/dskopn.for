...
C         (ASCII codes decimal 0-31 and 127-255), an error is signaled
C         by a routine in the call tree of this routine. No file will be
C         created.
C
C     7)  If the number of comment characters allocated NCOMCH is
C         negative, an error is signaled by a routine in the call
...
C$ Version
C
C-    SPICELIB Version 1.0.1, 02-JUL-2021 (JDR)
C
