...
C
C              CHARACTER*(*)         META
C              PARAMETER           ( META   = 'spkcvo_ex1.tm' )
C
C              CHARACTER*(*)         TIMFMT
C              PARAMETER           ( TIMFMT =
...
C              62512272.82076502   58967494.42506485 -122059095.46751761
...
C
C         Distance between last two positions (km):           3.07056969
C
...
C$ Version
C
C-    SPICELIB Version 1.0.1, 25-MAY-2021 (JDR)
C
C        Edited the header to comply with NAIF standard.
C
C        Modified code examples output format for the solutions to fit
