...
C     DATA      O    List of decoded integers.
C
C$ Detailed_Input
C
...
C              in the text file.
C
C     N        is the number of encoded integers to be read from the
C              text file attached to UNIT.
C
C$ Detailed_Output
C
C     DATA     is the list of decoded integers read from the text file
C              attached to UNIT.
C
C$ Parameters
C
