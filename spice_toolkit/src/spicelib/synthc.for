...
C$ Exceptions
C
C     1)  If there is an issue while reading the components of a
C         character symbol table, an error is signaled by a routine in
C         the call tree of this routine. This normally indicates that
C         the character symbol table is corrupted.
C
C$ Files
C
C     None.
