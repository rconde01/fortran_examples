...
C        HANDLE in $Detailed_Input section, and referred to it from
C        $Files.
C
...
C        cannot know about leading/embedded blanks when it appends, so
C        blanks were inadvertently removed when they happened to be
...
C         SPICE(SPCRFLNOTCALLED) is signaled.
C
