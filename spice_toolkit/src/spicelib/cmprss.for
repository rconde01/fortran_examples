...
C     Error free.
C
C     1)  If the output string length is too short to contain the result
C         of compressing the input string, the result is truncated on
C         the right.
C
C$ Files
C
...
C$ Version
C
C-    SPICELIB Version 1.1.0, 09-JUL-2021 (JDR)
C
C        Added IMPLICIT NONE statement.
C
C        Edited the header to comply with NAIF standard.
C
C        Added $Exceptions entry #1.
C
