...
C
C     Initialize the table of built-in frame names and their ID codes
C     and hashes and order arrays providing efficient access to these
C     tables.
C
C$ Disclaimer
C
...
C$ Version
C
C-    SPICELIB Version 5.2.0, 07-SEP-2021 (BVS) (JDR)
C
...
C           IAU_MENOETIUS
C
C        Corrected frame name spelling:
C
C           IAU_MAGACLITE -> IAU_MEGACLITE
C
...
C$ Index_Entries
C
C     initialize built-in frame names and ID codes
C
C-&
...
C     routine.
C
C     NAME   ( NINERT + 125 ) =  name
C     IDCODE ( NINERT + 125 ) =  10125
C     CENTER ( NINERT + 125 ) =  center
C     TYPID  ( NINERT + 125 ) =  type ID code
C     TYPE   ( NINERT + 125 ) =  type (INERTL, PCK, etc. )
C
