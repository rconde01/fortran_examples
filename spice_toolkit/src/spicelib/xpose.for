...
C     --------  ---  --------------------------------------------------
C     M1         I   3x3 matrix to be transposed.
C     MOUT       O   Transpose of M1.
C
C$ Detailed_Input
C
...
C$ Detailed_Output
C
C     MOUT     is a double precision, 3x3 matrix which contains the
C              transpose of M1.
C
C$ Parameters
C
...
C     variable in the following order:
C
C        (1,2) <---> (2,1)
C        (1,3) <---> (3,1)
C        (2,3) <---> (3,2)
...
C
C     1) Given a 3x3 double precision matrix, find its transpose.
C
C
...
C
C        C
C        C     Define the input matrix.
C        C
C              DATA                  M1     /  1.0D0,  0.0D0,  0.0D0,
C             .                                2.0D0,  4.0D0,  6.0D0,
C             .                                3.0D0,  5.0D0,  0.0D0 /
C
C        C
C        C     Compute the transpose of M1.
C        C
C              CALL XPOSE ( M1, MOUT )
C
C        C
C        C     Display the results.
C        C
C              WRITE(*,*) 'Input matrix (M1):'
C              WRITE(*,*)
C              DO I= 1, 3
C                 WRITE(*,'(3F6.1)') ( M1(I,J), J= 1, 3 )
C              END DO
C              WRITE(*,*)
C              WRITE(*,*) 'Transpose of M1:'
C              WRITE(*,*)
C              DO I= 1, 3
C                 WRITE(*,'(3F6.1)') ( MOUT(I,J), J= 1, 3 )
C              END DO
C
C              END
C
