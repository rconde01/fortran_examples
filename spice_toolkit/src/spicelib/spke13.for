...
C$ Exceptions
C
C     1)  If an error occurs while interpolating the SPK data, the
...
C        $Exceptions section to describe possible issues detected by
C        this routine. Moved SPK required reading from
