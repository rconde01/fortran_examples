...
C$ Restrictions
C
C     1)  The array of MARKS, MRKLEN, and PNTERS must be properly
C         formatted prior to calling SCAN. This is accomplished by
C         calling SCANPR.
C
...
C$ Restrictions
C
C     1)  MRKLEN and PNTERS must be declared to be at least as large
...
C$ Abstract
C
C     Scan a string and return the beginnings and ends of recognized
C     and unrecognized substrings. The full collection of these
C     substrings partitions the string.
C
C$ Disclaimer
C
C     THIS SOFTWARE AND ANY RELATED MATERIALS WERE CREATED BY THE
...
C$ Restrictions
C
C     1)  The arrays MARKS, MRKLEN, and PNTERS must be prepared by the
