...
C              segment preceding DLADSC is sought.
C
...
C              segment associated with the input argument DLADSC.
C
...
C
C     2)  If a failure occurs while reading the DLA file, an error
...
C        Added solution for code example.
C
