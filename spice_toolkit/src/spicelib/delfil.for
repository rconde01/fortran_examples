...
C$ Restrictions
C
C     1)  The file to be deleted must be closed when this routine is
C         invoked.
C
...
C$ Version
C
C-    SPICELIB Version 1.0.1, 02-JUN-2021 (JDR)
C
