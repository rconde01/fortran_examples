...
C
C     1) The following test program creates a quaternion and quaternion
...
C        C     precision.
C        C
C              WRITE(*,*) 'Original angular velocity:'
C              WRITE(*,'(1X,3F20.16)') EXPAV
C              WRITE(*,*) 'QDQ2AV''s angular velocity:'
C              WRITE(*,'(1X,3F20.16)') AV
C              WRITE(*,*) 'XF2RAV''s angular velocity:'
C              WRITE(*,'(1X,3F20.16)') AVX
C
C              END
C
C
...
C
C
C         Original angular velocity:
C           1.0000000000000000  2.0000000000000000  3.0000000000000000
C         QDQ2AV's angular velocity:
C           0.9999999999999998  1.9999999999999996  2.9999999999999991
C         XF2RAV's angular velocity:
C           1.0000000000000002  2.0000000000000000  3.0000000000000000
C
C
C$ Restrictions
C
...
C$ Version
C
C-    SPICELIB Version 1.1.2, 04-JUL-2021 (JDR)
C
C        Edited the header to comply with NAIF standard..
C        Changed code example output format to fit within the $Examples
C        section without modifications.
C
