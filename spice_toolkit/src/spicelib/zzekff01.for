...
C$ Version
C
C-    SPICELIB Version 1.1.0, 11-OCT-2021 (NJB)
C
C        All local arrays are now completely initialized.
C
...
C
      CALL CLEARI ( BUFSIZ, ADRBUF )
      CALL CLEARI ( MXCLSG, COLORD )
      CALL CLEARI ( PGSIZI, IPAGE  )
      CALL CLEARI ( SDSCSZ, SEGDSC )
