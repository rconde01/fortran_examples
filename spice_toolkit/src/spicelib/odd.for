...
C
C     The function returns .TRUE. if IVAL is odd, otherwise .FALSE.
C
C$ Detailed_Input
C
C     IVAL     is the integer to be tested for oddness.
C
C$ Detailed_Output
C
C     The function returns .TRUE. if IVAL is odd, .FALSE. if IVAL is
C     even.
C
C$ Parameters
C
...
C$ Particulars
C
C     Divide IVAL by two. If the remainder is one, IVAL is odd.
C
C$ Examples
C
