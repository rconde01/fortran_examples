...
C$ Version
C
C-    SPICELIB Version 1.1.0, 23-NOV-2020 (JDR) (NJB)
C
C        Fixed typo in short error message in entry point ZZDSKMRC.
C        Corrected Brief_I/O descriptions of input DSKDSC in all entry
C        points that accept this input argument.
C
...
C     DSKDSC     I   DSK descriptor of segment to be checked.
C
...
C$ Version
C
C-    SPICELIB Version 1.0.1, 23-NOV-2020 (NJB)
C
C        Corrected Brief_I/O description of input DSKDSC.
C
C-    SPICELIB Version 1.0.0, 11-JUL-2016 (NJB)
C
C-&
...
C$ Version
C
C-    SPICELIB Version 1.0.1, 23-NOV-2020 (JDR) (NJB)
C
C        Corrected Brief_I/O description of input DSKDSC.
C
C-    SPICELIB Version 1.0.0, 11-JUL-2016 (NJB)
...
C-    SPICELIB Version 1.0.1, 23-NOV-2020 (JDR) (NJB)
C
C        Fixed typo in short error message SPICE(NOTSUPPORTED).
C        Corrected Brief_I/O description of input DSKDSC.
C
C-    SPICELIB Version 1.0.0, 11-JUL-2016 (NJB)
C
