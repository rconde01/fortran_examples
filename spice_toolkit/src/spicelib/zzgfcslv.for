...
C$ Version
C
C-    SPICELIB Version 1.3.0, 03-OCT-2021 (NJB)
C
C        Variable CNAMES is now saved. Corrected typos in comments.
C
C-    SPICELIB Version 1.2.0, 04-APR-2011 (EDW)
C
C        Replaced use of routines ZZGFREL with ZZGFRELX, and
