...
C
C     2)  If the input handle is invalid, an error is signaled by a
...
C         guarantees.
C
C     4)  If any DAS read error is detected, the error is signaled by a
C         routine in the call tree of this routine.
C
C$ Files
C
...
C
C        When this program was executed on a Mac/Intel/gfortran/64-bit
C        platform, using the DSK file named phobos512.bds and an empty
C        string instead of the meta-kernel name, the output was:
C
C
C        Enter DSK name         > phobos512.bds
...
C            Longitude (deg):     -180.000000000000   180.000000000000
C            Latitude  (deg):      -90.000000000000    90.000000000000
C            Radius     (km):        8.049632248722    13.940939832124
C
C
...
C        DSKW02. Use the meta-kernel shown below to demonstrate surface
C        name-ID mapping.
C
C
C           KPL/MK
...
C
C
C        When Example #2 was executed on a Mac/Intel/gfortran/64-bit
C        platform, using the DSK file named phobos_3_3_3seg.bds and the
C        meta-kernel dskgd_ex3.tm, the output was:
C
C
...
C            Longitude (deg):     -180.000000000000   180.000000000000
C            Latitude  (deg):      -90.000000000000    90.000000000000
C            Radius     (km):        8.225298075974    14.011768145626
C         ====================================
...
C           Segment boundaries:
C            X-coordinate (km):     -1.300000000000     1.310000000000
C            Y-coordinate (km):     -1.210000000000     1.200000000000
C            Z-coordinate (km):     -9.452932357788     9.638179779053
C         ====================================
...
C            Longitude (deg):     -180.000000000000   180.000000000000
C            Latitude  (deg):      -90.000000000000    90.000000000000
C            Altitude   (km):       -3.728668683604     1.372015791081
C
C
C$ Restrictions
C
...
C
C        Edited the header to comply with NAIF standard. Extended the
C        $Exceptions section and updated the $Restrictions.
C
