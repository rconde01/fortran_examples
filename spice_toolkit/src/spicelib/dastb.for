...
C
C     BINFIL   is the name of the binary DAS file to be created.
C
C$ Detailed_Output
C
C     None.
...
C
C     3)  If an error occurs while attempting to decode data in the DAS
C         transfer file, the error SPICE(BADDASTRANSFERFILE) is
C         signaled.
C
C     4)  If the DAS file cannot be written, an error is signaled by a
...
C$ Version
C
C-    SPICELIB Version 3.3.0, 02-JUN-2021 (JDR)
C
