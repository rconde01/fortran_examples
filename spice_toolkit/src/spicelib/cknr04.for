...
C$ Abstract
C
C     Return the number of pointing records in a CK type 04 segment.
...
C
C     DESCR    is the packed descriptor of a data type 4 segment.
C
C$ Detailed_Output
C
C     NREC     is the number of pointing records in the type 4
C              segment.
C
C$ Parameters
C
