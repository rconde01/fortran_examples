...
C$ Detailed_Input
C
C     V        is any double precision, 3-dimensional vector. If this
C              vector is the zero vector, this routine will detect it,
C              and will not attempt to divide by zero.
C
C$ Detailed_Output
C
C     V        is the unit vector in the direction of the input vector.
C              If on input V represents the zero vector, then V will be
