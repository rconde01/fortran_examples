...
C
C         However, this routine is part of the interface to the SPICELIB
C         error handling mechanism. For this reason, this routine does
C         not participate in the trace scheme, even though it has
