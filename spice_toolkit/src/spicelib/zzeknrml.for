...
C     PRSERR.  No errors are signaled.  The possible error messages
...
C
C     NRELOP is the number of arithmetic and character comparison
C     operators.
C
      INTEGER               NRELOP
      PARAMETER           ( NRELOP = 8 )
...
C     represented as a disjunction of conjunctions, for example
C
