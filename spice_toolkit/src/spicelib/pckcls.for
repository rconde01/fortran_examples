...
C$ Detailed_Input
C
C     HANDLE   is the handle of the PCK file that is to be closed.
C
C$ Detailed_Output
C
C     None.
...
C        C
C              CHARACTER*(*)         FNAME
C              PARAMETER           ( FNAME = 'pckcls_ex1.bpc' )
C
C              INTEGER               BODY
...
C$ Version
C
C-    SPICELIB Version 1.1.2, 03-JUN-2021 (JDR)
C
