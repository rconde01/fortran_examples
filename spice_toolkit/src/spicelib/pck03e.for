...
C     None.
C
C     The segment in the PCK file associated with HANDLE will
...
C$ Exceptions
C
C     1)  If there is no segment being written to the file associated
C         with HANDLE, an error is signaled by a routine in the call
