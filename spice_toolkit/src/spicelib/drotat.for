...
C$ Detailed_Input
C
C     ANGLE    is the angle given in radians, through which the rotation
C              is performed.
C
C     IAXIS    is the coordinate axis number of the rotation. The X, Y,
...
C$ Detailed_Output
C
C     DMOUT    is the derivative of the rotation matrix with respect to
C              the angle of rotation. That is, DMOUT is the derivative
