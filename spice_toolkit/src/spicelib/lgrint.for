...
C         SPICE(DIVIDEBYZERO) is signaled. The function will return the
C         value 0.D0.
C
...
C
C        The returned value of LGRINT should be 1.D0, since the
...
C        Added "IMPLICIT NONE" to code example.
C
