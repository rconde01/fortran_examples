...
C              be pushed.
C
C              If NAME is not in the symbol table, a new symbol is
C              created.
C
C     TABSYM,
C     TABPTR,
...
C     TABVAL   are the components of a character symbol table.
C
C              The value is added to the symbol table at the front of
C              the previous value(s) associated with the symbol NAME. If
C              NAME is not originally in the symbol table, a new symbol
C              is created.
C
C$ Parameters
C
