...
C$ Detailed_Input
C
C     STRING   is a character string that represents a numeric value.
...
C
C     3)  If the string represents a number that is outside the range of
C         representable integers, as defined by INTMIN() and INTMAX(),
