...
C$ Abstract
C
C     Fetch from the constants partition of a generic segment the 
C     double precision numbers from FIRST to LAST. The segment is 
...
C         constants, the error SPICE(REQUESTOUTOFBOUNDS) is signaled.
C
