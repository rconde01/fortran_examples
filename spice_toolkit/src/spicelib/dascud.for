...
C         is signaled.
C
C     3)  If NWORDS is negative, the error SPICE(VALUEOUTOFRANGE) is
C         signaled.
C
C$ Files
C
...
C$ Version
C
C-    SPICELIB Version 1.5.0, 13-AUG-2021 (JDR)
C
...
C
C        Bug fix: added initialization of variable LTYPE to support
