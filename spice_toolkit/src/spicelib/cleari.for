...
C$ Detailed_Output
C
C     ARRAY    is the integer array which is to be filled with
C              zeros.
C
C$ Parameters
C
...
C        and clear it afterwards.
C
C
C        Example code begins here.
C
C
C              PROGRAM CLEARI_EX1
C              IMPLICIT NONE
C
C        C
...
C
C        C
C        C     Initialize all member of the array ARRAY to 11, and
C        C     print out its contents.
C        C
C              CALL FILLI ( 11, NDIM, ARRAY )
C
C              WRITE(*,'(A)') 'Contents of ARRAY before CLEARI:'
C              WRITE(*,'(4I4)') ( ARRAY(I), I=1, NDIM )
C
C        C
C        C     Clear the contents of ARRAY and print it.
C        C
C              CALL CLEARI ( NDIM, ARRAY )
C
C              WRITE(*,*)
C              WRITE(*,'(A)') 'Contents of ARRAY after CLEARI:'
C              WRITE(*,'(4I4)') ( ARRAY(I), I=1, NDIM )
C
C              END
C
...
C
C
C        Contents of ARRAY before CLEARI:
C          11  11  11  11
C
C        Contents of ARRAY after CLEARI:
C           0   0   0   0
C
C
C$ Restrictions
...
C$ Version
C
C-    SPICELIB Version 1.1.0, 19-MAY-2021 (JDR)
C
