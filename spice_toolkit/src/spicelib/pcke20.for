...
C        binary PCK files.
C
C        The data returned by the PCKRnn routine are in their rawest
C        form, taken directly from the segment. As such, they will be
C        meaningless to a user unless he/she understands the structure
C        of the data type completely. Given that understanding, however,
C        the PCKRnn routines might be used to examine raw segment data
C        before evaluating it with the PCKEnn routines.
C
C
