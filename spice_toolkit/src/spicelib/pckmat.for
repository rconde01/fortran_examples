...
C$ Abstract
C
C     Return the name of an inertial reference frame and the 6 x 6 
C     state transformation matrix from that frame to the body fixed 
C     frame of a given body at a specified epoch.
C
C$ Disclaimer
C
...
C         is signaled.
C
C     2)  If any issue is detected while reading PCK data, an error is
