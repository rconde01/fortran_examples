...
C$ Abstract
C
C     Find the index of the array element closest to a given integer X
C     in an array of non-decreasing integers.
C
C$ Disclaimer
C
...
C$ Restrictions
C
C     1)  If the sequence is not non-decreasing, the routine will run
