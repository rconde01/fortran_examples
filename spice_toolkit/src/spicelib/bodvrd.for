...
C         signaled.
C
C     4)  If the dimension of VALUES indicated by MAXN is too small to
...
C     lower-level routine GDPOOL should be used instead. GDPOOL supports
...
C        C
C              WRITE(*,'(A,3F10.3)') 'EARTH RADII: ', VALUES
C
C        C
C        C     The call
C        C
...
C
C        C
C        C     will produce the same results since the case of the
C        C     input argument BODYNM is not significant.
C        C
C              WRITE(*,'(A,3F10.3)') 'earth RADII: ', VALUES
C
C        C
...
C
C        C
C        C     will also produce the same results since strings
C        C     containing integer codes are accepted
C        C     by this routine.
C        C
...
C
C
C        EARTH RADII:   6378.140  6378.140  6356.750
C        earth RADII:   6378.140  6378.140  6356.750
...
C$ Version
C
C-    SPICELIB Version 1.2.1, 27-AUG-2021 (JDR)
C
