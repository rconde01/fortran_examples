...
C$ Version
C
C-    SPICELIB Version 1.0.1, 05-NOV-2021 (NJB)
C
C        Corrected I/O descriptions in header of entry point ZZSRFC2N.
C
...
C$ Detailed_Output
C
C     SRFNAM     is the name of the surface corresponding to the input
C                surface ID code and body ID code.
C
C                If multiple assignments for the input surface ID and
C                body ID are present in the kernel pool, the latest one
C                is used to determine SRFNAM.
C
C     FOUND      is a logical flag that is .TRUE. if the inputs
...
C-    SPICELIB Version 1.0.1, 05-NOV-2021 (NJB)
C
C        Corrected errors in the $Brief_I/O and $Detailed_Output
