...
C$ Abstract
C
C     Return .TRUE. if the derivative of the callback function UDFUNC
C     at a given abscissa value is negative.
C
C$ Disclaimer
C
...
C$ Detailed_Output
C
C     ISDECR   is a scalar boolean indicating if the first derivative
...
C     derivative value returned by UDDF. Please refer to this routine
