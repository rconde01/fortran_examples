...
C$ Abstract
C
C     Return the latest version string of a given item such as the
C     Toolkit or a routine name.
C
C$ Disclaimer
C
...
C$ Detailed_Input
C
C     ITEM     is the item for which a version string is to be returned.
C              ITEM may be 'TOOLKIT', entry point names, or program
C              names. ITEM is case insensitive.
C
C              Currently, the only ITEM supported is 'TOOLKIT' and it
C              will return the toolkit version number.
C
...
C
C              If ITEM is not one of the items having a version, the
C              value 'No version found.' will be returned.
C
C$ Parameters
C
C     None.
...
C$ Version
C
C-    SPICELIB Version 3.16.0, 31-DEC-2021 (WLT)
C
C        Version update, N0067
C
C-    SPICELIB Version 3.15.0, 20-AUG-2021 (JDR)
C
C        Added IMPLICIT NONE statement.
C
C        Edited the header to comply with NAIF standard.
C
C-    SPICELIB Version 3.14.0, 05-APR-2017 (BVS)
C
C        Version update, N0066
C
C-    SPICELIB Version 3.13.0, 15-JUL-2014 (BVS)
C
C        Version update, N0065
C
C-    SPICELIB Version 3.12.0, 09-JUN-2010 (BVS)
C
C        Version update, N0064
C
C-    SPICELIB Version 3.11.0, 15-APR-2009 (BVS)
C
C        Version update, N0063
C
C-    SPICELIB Version 3.10.0, 04-MAR-2008 (BVS)
C
C        Version update, N0062
C
C-    SPICELIB Version 3.9.0, 27-NOV-2006 (BVS)
C
C        Version update, N0061
C
C-    SPICELIB Version 3.8.0, 16-DEC-2005 (BVS)
C
C        Version update, N0060
C
C-    SPICELIB Version 3.7.0, 17-NOV-2005 (BVS)
C
C        Version update, N0059
C
C-    SPICELIB Version 3.6.0, 11-JAN-2005 (BVS)
C
C        Version update, N0058
C
C-    SPICELIB Version 3.5.0, 02-MAR-2004 (BVS)
C
C        Version update, N0057
C
C-    SPICELIB Version 3.4.0, 30-JUL-2003 (BVS)
C
C        Version update, N0056
C
C-    SPICELIB Version 3.3.0, 26-FEB-2003 (BVS)
C
C        Version update, N0055
C
C-    SPICELIB Version 3.2.0, 13-DEC-2002 (BVS)
C
C        Version update, N0054
C
C-    SPICELIB Version 3.1.0, 05-SEP-2002 (BVS)
C
...
C        has been signaled to get the toolkit version, so it
C        cannot return on entry after an error.
C
C        The calls to CHKIN and CHKOUT have also been removed to
C        completely isolate this subroutine from the error handling.
C
C        Version update, N0043.
C
C-    SPICELIB Version 1.7.0, 02-JAN-1996 (WLT)
C
...
C
C-    SPICELIB Version 1.4.0, 05-JUN-1995 (HAN)
C
