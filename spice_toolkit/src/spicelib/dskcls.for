...
C$ Exceptions
C
C     1)  If an error occurs when the file is closed, the error is
...
C$ Version
C
C-    SPICELIB Version 1.1.0, 12-OCT-2021 (JDR) (NJB)
C
C        Bug fix: now calls FAILED after call to DASHAM.
C     
