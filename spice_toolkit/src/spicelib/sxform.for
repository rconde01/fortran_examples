...
C         SPICE kernels to compute the transformation between the two
C         frames, an error is signaled by a routine in the call tree of
C         this routine.
C
...
C$ Version
C
C-    SPICELIB Version 1.1.1, 05-JUL-2021 (JDR)
C
