...
C$ Abstract
C
C     Make a SPICE plane from a point and two spanning vectors.
C
C$ Disclaimer
C
...
C     POINT,
C     SPAN1,
C     SPAN2    are, respectively, a point and two spanning vectors that
C              define a geometric plane in three-dimensional space. The
C              plane is the set of vectors
C
C                 POINT   +   s * SPAN1   +   t * SPAN2
C
C              where `s' and `t' are real numbers. The spanning vectors
C              SPAN1 and SPAN2 must be linearly independent, but they
C              need not be orthogonal or unitized.
C
C$ Detailed_Output
C
C     PLANE    is a SPICE plane that represents the geometric plane
C              defined by POINT, SPAN1, and SPAN2.
C
C$ Parameters
C
C     None.
...
C$ Exceptions
C
C     1)  If SPAN1 and SPAN2 are linearly dependent, i.e. the vectors
