...
C         open for write access, an error is signaled by a routine
...
C        C
C              CHARACTER*(*)         DLA
C              PARAMETER           ( DLA    = 'dlabns_ex1.dla' )
C
C              INTEGER               IFNLEN
...
C$ Version
C
C-    SPICELIB Version 1.0.1, 14-JUN-2021 (JDR)
C
C        Edited the header to comply with NAIF standard. Modified
C        the presentation of the output in the code example to comply
C        with the maximum line length for the header comments.
C
