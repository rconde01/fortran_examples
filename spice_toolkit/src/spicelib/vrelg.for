...
C     --------  ---  --------------------------------------------------
C     V1,
C     V2         I   Input vectors.
C     NDIM       I   Dimension of V1 and V2.
C
C     The function returns the relative difference between two vectors
C     of general dimension.
C
C$ Detailed_Input
C
C     V1,
C     V2       are two vectors for which the relative difference is to
C              be computed.
C
...
C$ Detailed_Output
C
C     The function returns the relative difference between the two input
C     n-dimensional vectors V1 and V2.
C
C     It is defined as:
C
C                          || V1 - V2 ||
...
C
C     VRELG assumes values in the range [0,2]. If both V1 and V2 are
C     zero vectors then VRELG is defined to be zero.
C
C$ Parameters
C
C     None.
...
C     Error free.
C
C     1)  If both V1 and V2 are zero vectors, then VRELG is defined to
C         be zero.
C
C$ Files
C
