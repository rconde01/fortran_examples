...
C$ Detailed_Output
C
C     C        is the output SPICE window, containing the difference
...
C$ Version
C
C-    SPICELIB Version 2.1.0, 24-AUG-2021 (JDR) (NJB)
C
...
C
C        Added entry #2 in $Exceptions section.
C
...
C
      ...
      PUT = 1
C
C     As long as the end pointer for A is less than the cardinality
