...
C$ Exceptions
C
C     1)  If an invalid message type is provided in LIST, the error
C         SPICE(INVALIDLISTITEM) is signaled.
C
C$ Files
C
C     None.
...
C$ Version
C
C-    SPICELIB Version 5.29.0, 28-NOV-2021 (BVS)
C
C        Updated for MAC-OSX-M1-64BIT-CLANG_C.
C
C-    SPICELIB Version 5.28.0, 13-AUG-2021 (JDR)
C
