...
C$ Detailed_Input
C
C     CODE     is the integer code for a body: planet, satellite,
C              barycenter, spacecraft, asteroid, comet, or
C              other ephemeris object.
C
C$ Detailed_Output
C
C     NAME     is the string name of the body identified by CODE
...
C$ Particulars
C
C     BODC2S is one of five related subroutines,
C
...
C
C     1) Apply the BODC2S call to several IDs representing codes
...
C
C
C        Note that the codes 11 and 6000001 did not map to a name so the
C        call returns as NAME the string expression of the codes.
C
C$ Restrictions
C
C     None.
...
C$ Version
C
C-    SPICELIB Version 1.1.0, 07-JUL-2021 (JDR)
C
