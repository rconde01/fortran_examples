...
C
C     The function returns the index of the first non-blank printable
...
C$ Detailed_Output
C
C     The function returns the index of the first printable character in
C     the input string.
C
C     ASCII characters 33-126 are considered to be printable characters.
C     Blanks are not considered printable characters. If the input
C     string contains no printable characters, FRSTPC is zero.
C
C$ Parameters
C
C     None.
...
C$ Particulars
C
C     This works exactly like FRSTNB, except that it skips non-printable
C     characters (ASCII control characters) as well as blanks.
C
C$ Examples
C
C     The program
