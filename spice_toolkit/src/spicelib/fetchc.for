...
C$ Abstract
C
C     Return the location within the set array of the NTH element within
C     the order imposed by the ASCII collating sequence.
C
C$ Disclaimer
C
...
C         is signaled, and the value of FETCHC is zero.
C
C$ Files
C
C     None.
...
C        SET( CARDC ( SET ) )
C
C     Likewise, the elements may be retrieved in the order imposed by
