...
C$ Version
C
C-    SPICELIB Version 1.1.0, 20-AUG-2021 (JDR)
C
C        Added IMPLICIT NONE statement.
C
C        Edited the header to comply with NAIF standard. Updated
C        description of MAXL parameter and added $Exceptions and
C        $Restrictions.
C
...
C        superseding the BODTRN from SUPPORT, the body ID code/name
