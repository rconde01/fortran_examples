...
C
C              WRITE (*, '(1X,A,3E18.10)' ) ' I1 = ',
C             .          (IVERTS(I,1), I = 1, 3)
C              WRITE (*, '(1X,A,3E18.10)' ) ' I2 = ',
C             .          (IVERTS(I,2), I = 1, 3)
C              WRITE (*, '(1X,A,3E18.10)' ) ' I3 = ',
C             .          (IVERTS(I,3), I = 1, 3)
C
C              WRITE (*,*) ' '
C              WRITE (*,*) 'Vertices of output plate: '
C
C              WRITE (*, '(1X,A,3E18.10)' ) ' O1 = ',
C             .          (OVERTS(I,1), I = 1, 3)
C              WRITE (*, '(1X,A,3E18.10)' ) ' O2 = ',
C             .          (OVERTS(I,2), I = 1, 3)
C              WRITE (*, '(1X,A,3E18.10)' ) ' O3 = ',
C             .          (OVERTS(I,3), I = 1, 3)
C              WRITE (*,*) ' '
C              END
C
...
C          I1 =   0.8660254038E+00 -0.5000000000E+00  0.7000000000E+01
C          I2 =   0.0000000000E+00  0.1000000000E+01  0.7000000000E+01
C          I3 =  -0.8660254038E+00 -0.5000000000E+00  0.7000000000E+01
C
C         Vertices of output plate:
C          O1 =   0.1732050808E+01 -0.1000000000E+01  0.7000000000E+01
C          O2 =   0.0000000000E+00  0.2000000000E+01  0.7000000000E+01
C          O3 =  -0.1732050808E+01 -0.1000000000E+01  0.7000000000E+01
C
C
...
C
C        Edits to code example output format for the solution to fit
C        within the $Examples section without modifications.
C
