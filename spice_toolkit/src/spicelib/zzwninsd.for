...
C                  to be inserted.
C
C      CONTEXT     a context/explanation string to append to the
...
C$ Version
C
C-     SPICELIB Version 1.1.1, 05-OCT-2021 (NJB)
C
C         Corrected typos in long error messages and in comments.
C
...
C$ Index_Entries
C
C     insert interval into d.p. window, with context string
C
C-&
...
C
      IF ( LEFT .GT. RIGHT ) THEN
         ...
         MSG = 'Left endpoint greater-than right. Left endpoint '
