...
C
C              If, for the body specified by BODSTR, multiple surface
C              names are associated with one surface ID code, then any
C              of these names may be used as the value of SRFSTR.
C
...
C$ Version
C
C-    SPICELIB Version 1.0.1, 22-OCT-2021 (JDR) (NJB)
C
C        Edited the header to comply with NAIF standard.
C
C        Updated description of SRFSTR to indicate that any
C        surface name alias may be used.
C
