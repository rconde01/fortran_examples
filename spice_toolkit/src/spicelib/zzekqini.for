C$Procedure   ZZEKQINI ( Private: EK, initialize encoded query )
...
C        too small, the error SPICE(CELLTOOSMALL) will be signaled.
C
...
C        error  SPICE(STRINGTOOSHORT) will be signaled.
C
C$ Files
C
C     None.
...
C$ Version
C
C-    SPICELIB Version 1.0.1, 02-OCT-2021 (NJB)
C
