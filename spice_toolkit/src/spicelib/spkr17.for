...
C$ Abstract
C
C     Read a single SPK data record from a segment of type 17
...
C
C        Edited the header to comply with NAIF standard. Fixed textual
C        description of SPK type in $Abstract.
C
...
C
C-    SPICELIB Version 1.0.0, 03-JAN-1997 (WLT) (SS)
C
C-&
