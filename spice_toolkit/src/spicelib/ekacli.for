...
C        named 'ekacli_ex1.bes' which contains records of orders for
...
C
C
C        The file "ekacli_ex1.bdb" will contain two segments, the first
...
C
C              CALL EKOPN ( 'ekacli_ex1.bes', IFNAME, NRESVC, HANDLE )
C
C        C
