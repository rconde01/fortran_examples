...
C              containing the table TABNAM may be loaded. Sets of
C              columns, column names and attributes must be
...
C         routine.
C
C     4)  If the catalog file is not a type 1 star catalog file, the
C         error SPICE(BADCATALOGFILE) is signaled.
C
C$ Files
C
