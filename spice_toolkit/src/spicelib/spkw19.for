...
C         than LAST, the error SPICE(COVERAGEGAP) is signaled.
C
...
C         is signaled.
C
C     14) If an error occurs while writing the output segment, the error
...
C$ Version
C
C-    SPICELIB Version 2.0.1, 03-JUN-2021 (JDR)
C
