...
C     C        relative to the solar system barycenter at ET, expressed
...
C$ Version
C
C-    SPICELIB Version 1.2.0, 12-SEP-2021 (NJB)
C
C        Bug fix: aberration correction strings are now parsed using
C        ZZVALCOR. This improves error checking.
C
C        Corrected a header comment typo.
C
