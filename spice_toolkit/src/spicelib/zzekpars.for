...
C         error message, instead of signaling errors.  The
...
C     it transforms correct queries into the EK system's encoded query
C     representation.
C
...
C$ Version
C
C-    SPICELIB Version 4.1.1, 03-OCT-2021 (NJB)
C
