...
C$ Abstract
C
C     Convert from spherical coordinates to cylindrical coordinates.
C
C$ Disclaimer
C
...
C     SLON       I   Azimuthal angle (longitude) of point (radians).
C     R          O   Distance of point from Z axis.
C     CLON       O   Angle (radians) of point from XZ plane.
...
C              the XZ plane. CLON is set equal to SLON.
C
...
C
C        C
C        C     Convert the spherical coordinates to cylindrical.
C        C
C              CALL SPHCYL ( RADIUS, COLAT, SLON, R, CLON, Z )
C
C        C
...
C
C        C
C        C     Define the input spherical coordinates. Input angles
C        C     in degrees.
C        C
...
C                 RSLON  = SLON(I)  * RPD()
C
C                 CALL SPHCYL( RADIUS(I), RCOLAT, RSLON, R, CLON, Z )
C
...
C            1.414   45.000  180.000    1.000  180.000    1.000
C            1.000   90.000  -90.000    1.000  -90.000    0.000
C            1.000  180.000    0.000    0.000    0.000   -1.000
C            1.000   90.000   45.000    1.000   45.000    0.000
C            1.414  135.000  180.000    1.000  180.000   -1.000
C            1.000    0.000  180.000    0.000  180.000    1.000
...
C
C        Changed the argument names LONGS and LONG to SLON and CLON for
