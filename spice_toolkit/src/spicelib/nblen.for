...
C
C     The function returns the non-blank length of STRING.
C
C$ Detailed_Input
C
...
C$ Detailed_Output
C
C     The function returns the non-blank length of STRING. This is the
C     same as the index of the last non-blank character in the left
C     justified string. If STRING is blank, NBLEN is zero.
C
C$ Parameters
C
C     None.
