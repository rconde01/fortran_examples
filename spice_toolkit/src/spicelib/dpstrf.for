...
C
C     2)  If the output string is not declared to be adequately large
...
C         input X and the number of significant digits requested. In
C         extreme cases up to 56 characters may be required.)
C
C     3)  This routine makes explicit use of the format of the string
...
C$ Version
C
C-    SPICELIB Version 1.2.1, 12-AUG-2021 (JDR)
C
