...
C
C     1) Return the value of the largest positive number representable
C        in a double precision variable.
C
...
C
C        C
C        C     Display the largest positive number representable
C        C     in a double precision variable.
C        C
C              WRITE(*,'(A,E22.14)')
C             .                'Maximum Double Precision Number: ',
C             .                 DPMAX()
C
C
C              END
...
C
C
C        Maximum Double Precision Number:   0.17976931348623+309
C
C
C$ Restrictions
C
