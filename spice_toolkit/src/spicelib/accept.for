...
C
C         However, this routine is part of the SPICELIB error handling
C         mechanism.
C
C$ Files
C
...
C$ Abstract
C
C     Return .TRUE. if replacement or modification of the long error 
C     message is allowed. 
C
C     DO NOT CALL THIS ROUTINE.
C
C$ Disclaimer
...
C        following the header.
C
C-    SPICELIB Version 1.0.0, 31-JAN-1990 (NJB) (HAN)
C
C-&
