...
C     None.
C
C     The type 04 segment in the DAF file associated with HANDLE will be
C     ended, making the addition of the data to the file permanent.
C
C$ Parameters
C
C     None.
...
C$ Exceptions
C
C     1)  If an error occurs while reading or writing the file
C         indicated by HANDLE, the error is signaled by a routine in
...
C$ Version
C
C-    SPICELIB Version 1.0.2, 02-JUN-2021 (JDR)
C
