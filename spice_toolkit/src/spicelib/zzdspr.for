...
C$ Abstract
C
C     Provide deep space long period periodic contributions to the mean
C     elements. By design, these periodics are zero at epoch. This used
C     to be dscom which included initialization, but it's really a
C     recurring function.
C
C$ Disclaimer
C
...
C
C     MP         Calculated perturbed mean anomaly.
C
C$ Parameters
C
C     None.
...
C
C        Tweaked wording of header Abstract section.
