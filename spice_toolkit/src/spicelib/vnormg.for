...
C
C     NDIM     is the dimension of the input vector V1.
C
C$ Detailed_Output
C
...
C
C     1) Define a four-dimensional vector and calculate its magnitude.
C
C        Example code begins here.
C
C
C              PROGRAM VNORMG_EX1
C              IMPLICIT NONE
C
C        C
...
C
C              DATA                  V1 / 12.3D0, -4.32D0,
C             .                           76.0D0,  1.87D0 /
C
C        C
C        C     Compute the magnitude of V1
C        C
C              WRITE(*,*) 'Magnitude of v1: ', VNORMG ( V1, NDIM )
C
C              END
C
C
...
C
C
C         Magnitude of v1:    77.132673362201047
C
C
C     2) The following table show the correlation between various input
...
C            3      (-5.D-17, 0.D0, 12.D-17)          13.D-17
C
C$ Restrictions
C
C     None.
