...
C$ Detailed_Input
C
C     A        is a double precision, 3-dimensional vector. It the
C              vector whose component orthogonal to B is sought. (There
C              is a unique decomposition of A into a sum V + P, where V
C              is parallel to B and P is orthogonal to B. We want the
C              component P.)
C
...
C$ Version
C
C-    SPICELIB Version 1.2.0, 16-SEP-2020 (JDR)
C
