...
C$ Detailed_Output
C
C     POS      is a 3-dimensional vector that contains the position of
C              the target body, relative to the observing body. This
C              vector is rotated into the specified reference frame.
...
C$ Version
C
C-    SPICELIB Version 2.1.0, 09-OCT-2021 (JDR) (NJB)
C
...
C
C-    SPICELIB Version 1.0.0, 09-JUL-1998 (WLT)
C
C-&
