...
C
C     The function returns the sum of the elements of ARRAY.
C
C$ Detailed_Input
C
C     ARRAY    is the input double precision array.
C
C     N        is the number of elements in the array.
C
C$ Detailed_Output
C
C     The function returns the sum of the elements of the input array.
C     That is,
C
C        SUMAD( ARRAY, N ) = ARRAY(1) + ARRAY(2) + ... + ARRAY(N)
C
...
C     of the array are then added. If the number of elements is zero or
C     negative, SUMAD is zero.
C
C$ Examples
C
...
C$ Restrictions
C
C     1)  SUMAD does not check for overflow.
C
...
C$ Version
C
C-    SPICELIB Version 1.1.0, 09-APR-2021 (JDR)
C
