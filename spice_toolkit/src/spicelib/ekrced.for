...
C
C     NVALS,
C     DVALS    are, respectively, the number of values found in the
C              specified column entry and the set of values themselves.
C
C              For columns having fixed-size entries, when column entry
C              is null, NVALS is still set to the column entry size. For
C              columns having variable- size entries, NVALS is set to 1
C              for null entries.
C
...
C$ Version
C
C-    SPICELIB Version 1.3.1, 26-MAY-2021 (JDR)
C
