...
C         double precision, the error SPICE(WRONGDATATYPE) is signaled.
C
...
C
C     1) This example demonstrates how to add double precision values
...
C        C
C              CHARACTER*(*)         EKNAME
C              PARAMETER           ( EKNAME  = 'ekaced_ex1.bdb' )
C
C              CHARACTER*(*)         TABLE
...
C        C
C              CHARACTER*(*)         EKNAME
C              PARAMETER           ( EKNAME  = 'ekaced_ex2.bdb' )
C
C              CHARACTER*(*)         TABLE
...
C$ Version
C
C-    SPICELIB Version 1.2.1, 06-JUL-2021 (JDR)
C
