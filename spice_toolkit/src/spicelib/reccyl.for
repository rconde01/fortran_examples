...
C     CLON       O   Angle (radians) of the point from XZ plane
C     Z          O   Height of the point above XY plane.
C
C$ Detailed_Input
C
C     RECTAN   are the rectangular coordinates of the point of
C              interest.
C
C$ Detailed_Output
C
...
C              interest from XZ plane. The CLON range is [0, 2pi].
C
...
C
C     1) Compute the cylindrical coordinates of the position of the Moon
...
C
C        C
C        C     Convert the cylindrical to rectangular coordinates.
C        C
C
...
C
C        Corresponding rectangular and cylindrical coordinates are
...
C              DO I = 1, NREC
C
C                 CALL RECCYL( RECTAN(1,I), R, CLON, Z )
C
...
C
C        Changed the output argument name LONG to CLON for consistency
