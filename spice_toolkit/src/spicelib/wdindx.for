...
C     WORD       I   A string of consecutive printable letters.
C
C     The function returns the location of WORD within STRING.
C
C$ Detailed_Input
C
C     STRING   is a string of characters, potentially containing the
C              word.
C
C              Leading and trailing blanks are not significant in
C              STRING.
C
C     WORD     is a string of consecutive printable characters.
C
C              Leading and trailing blanks are not significant in
C              WORD.
C
C$ Detailed_Output
C
C     The function returns the location of WORD within STRING, providing
C     the index of the first letter of WORD within the input STRING. If
C     WORD does not exist or WORD is blank, the function returns zero.
C
C$ Parameters
C
C     None.
...
C$ Particulars
C
C     A word within a string is a substring beginning and ending with a
C     non-blank characters that is delimited by blanks on each end. (A
C     blank is assumed to precede and follow the first and last
...
C$ Version
C
C-    SPICELIB Version 1.1.0, 03-OCT-2021 (JDR)
C
