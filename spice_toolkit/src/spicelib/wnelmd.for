...
C$ Detailed_Input
C
C     POINT    is a point, which may or may not be contained in one of
C              the intervals in WINDOW.
C
C     WINDOW   is a SPICE window containing zero or more intervals.
C
C$ Detailed_Output
C
...
C$ Version
C
C-    SPICELIB Version 1.2.0, 25-AUG-2021 (JDR)
C
