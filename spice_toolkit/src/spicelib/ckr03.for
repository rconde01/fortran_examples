...
C     segments in a file applicable to the Mars Observer spacecraft bus
C     that are of data type 3, for a particular spacecraft clock time.
...
C$ Version
C
C-    SPICELIB Version 1.1.2, 12-AUG-2021 (NJB) (JDR)
C
...
C     is signaled and the return mode is not set to ABORT.
C
      FOUND = .FALSE.
