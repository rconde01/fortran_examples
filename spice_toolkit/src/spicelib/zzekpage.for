...
C$ Version
C
C-    SPICELIB Version 1.2.0, 14-OCT-2021 (BVS)
C
C        Bug fix: fixed routine name in CHKIN/CHKOUT calls in
C        entry point ZZEKPGPG (ZZEKPGBS -> ZZEKPGPG).
C
...
C
C        Bug fix: fixed routine name in CHKIN/CHKOUT calls (ZZEKPGBS 
C        -> ZZEKPGPG).
C
C-    Beta Version 1.0.0, 18-OCT-1995 (NJB)
C
