...
C     to a given integer X in an array of non-decreasing integers.
C
C$ Disclaimer
C
...
C              of ARRAY that is the greatest element less than or equal
C              to X is to be found.
C
...
C           2
C
C     steps to compute the value of LSTLEI.
C
...
C     the last occurrence of an integer strictly less than a value.)
