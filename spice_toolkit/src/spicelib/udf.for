...
C$ Abstract
C
C     Serve as a dummy function for GF routines expecting an UDFUNS
C     argument. It is a no-op routine with an argument signature
C     matching UDFUNS.
C
C$ Disclaimer
C
...
C     --------  ---  --------------------------------------------------
C     X          I   Double precision value, unused.
C     VALUE      I   Double precision value, unused.
C
C$ Detailed_Input
C
C     X        is a double precision value, unused.
C
C     VALUE    is a double precision value, unused.
C
C$ Detailed_Output
C
C     None.
