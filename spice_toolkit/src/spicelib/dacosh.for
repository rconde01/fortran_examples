...
C$ Abstract
C
C     Return the inverse hyperbolic cosine of a double precision
C     argument.
C
C$ Disclaimer
C
...
C
C     The function returns the inverse hyperbolic cosine of a double
C     precision number.
C
C$ Detailed_Input
C
C     X        is any double precision number greater than or equal to
C              1.
C
C$ Detailed_Output
C
C     The function returns the inverse hyperbolic cosine of the double
...
C$ Restrictions
C
C     1)  The value of the input variable X must be greater than or
C         equal to 1.0d0.
C
