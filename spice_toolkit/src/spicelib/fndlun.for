...
C          page 94.
C
C     [6]  "FORTRAN/9000 Reference HP 9000 Series 700 Computers", First
C          Edition, Hewlett Packard Company, pp.6-2 and 6-4, June 1991.
C
C     [7]  Silicon Graphics "Fortran 77 Programmer's Guide",
C          Document number 007-0711-030, page 1-20.
C
C     [8]  "Language Reference Manual", Absoft Fortran V3.2, section
C          7.3.1 (for the NeXT), p.7-4, 1993.
C
...
C$ Version
C
C-    SPICELIB Version 6.28.0, 28-NOV-2021 (BVS)
C
C        Updated for MAC-OSX-M1-64BIT-CLANG_C.
C
C-    SPICELIB Version 6.27.0, 17-JUN-2021 (JDR)
C
...
C         NeXT platforms.
C
C-    SPICELIB Version 4.0.0, 06-OCT-1992 (HAN)
C
...
C$ Version
C
C-    SPICELIB Version 6.1.0, 17-JUN-2021 (JDR)
C
C        Added IMPLICIT NONE statement.
C
...
C        following the header.
C
C-    SPICELIB Version 1.0.0, 31-JAN-1990 (CAC) (IMU) (HAN) (NJB)
C
C-&
...
C$ Abstract
C
C     Free a logical unit number reserved by RESLUN.
C
C$ Disclaimer
C
C     THIS SOFTWARE AND ANY RELATED MATERIALS WERE CREATED BY THE
...
C$ Version
C
C-    SPICELIB Version 6.1.0, 27-JUN-2021 (JDR)
C
C        Added IMPLICIT NONE statement.
C
C        Edited the header to comply with NAIF standard. Added
