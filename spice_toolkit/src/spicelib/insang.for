...
C     E1,
C     E2,
C     E3       are the three edges of a solid tetrahedral angle. (See
C              particulars for a discussion of the solid angle).
C
C$ Detailed_Output
C
...
C$ Restrictions
C
C     1)  This routine can suffer from extreme loss of precision if the
C         vectors E1, E2, E3 are too long compared to the lengths of the
C         line segments formed by their pairwise differences.
C
...
C$ Version
C
C-    SPICELIB Version 1.0.3, 12-AUG-2021 (JDR)
C
