...
C              frame associated with the front target body. Examples of
...
C              frame associated with the ``back'' target body. Examples
C              of such names are 'IAU_SATURN' (for Saturn) and 'ITRF93'
C              (for the Earth).
C
...
C              discarded before GFOCLT conducts its search.
C
C$ Detailed_Output
C
C     RESULT   is a SPICE window representing the set of time intervals,
C              within the confinement window, when the specified
...
C         to a NAIF ID code, an error is signaled by a routine
...
C         the observer body OBSRVR, an error is signaled by a
C         routine in the call tree of this routine.
C
C     6)  If the body designated by FRONT coincides with that
C         designated by BACK, an error is signaled by a routine
C         in the call tree of this routine.
C
C     7)  If either of the body model specifiers FSHAPE or BSHAPE
C         is not recognized, an error is signaled by a routine
C         in the call tree of this routine.
C
C     8)  If both of the body model specifiers FSHAPE and BSHAPE
C         specify point targets, an error is signaled by a
C         routine in the call tree of this routine.
C
C     9)  If one of the body model specifiers FSHAPE and BSHAPE
C         specifies a DSK model, and the other argument does not
C         specify a point target, an error is signaled by a routine in
...
C         routine in the call tree of this routine.
C
C     11) If a target body-fixed reference frame is not centered at the
C         corresponding target body, an error is signaled by a routine
C         in the call tree of this routine.
C
C     12) If the loaded kernels provide insufficient data to compute any
C         required state vector, an error is signaled by a routine in
C         the call tree of this routine.
C
...
C         of this routine.
C
C     14) If a point target is specified and the occultation type is set
C         to a valid value other than 'ANY', an error is signaled by a
C         routine in the call tree of this routine.
C
C     15) If the output SPICE window RESULT has size less than 2, the
C         error SPICE(WINDOWTOOSMALL) is signaled.
C
...
C         occultation condition is met, an error is signaled
C         by a routine in the call tree of this routine.
C
C     17) If the occultation type OCCTYP is invalid, an error is
C         signaled by a routine in the call tree of this routine.
C
C     18) If the aberration correction specification ABCORR is invalid,
...
C              ---------                     --------
C              de421.bsp                     Planetary ephemeris
C              sat427.bsp                    Satellite ephemeris for
C                                            Saturn
C              pck00008.tpc                  Planet orientation and
C                                            radii
C              naif0009.tls                  Leapseconds
...
C         Result window start, stop times (TDB):
C          2008 OCT 27 22:08:01.672540    2008 OCT 28 01:05:03.332576
C          2008 NOV 12 21:21:59.270691    2008 NOV 13 02:06:05.034713
C          2008 NOV 28 20:49:02.415745    2008 NOV 29 02:13:58.978004
C          2008 DEC 14 20:05:09.258916    2008 DEC 15 01:44:53.517960
C          2008 DEC 30 19:00:56.586894    2008 DEC 31 00:42:43.219311
C
C        Condition: ANNULAR occultation of SATURN by TITAN
C         Result window start, stop times (TDB):
C          2008 OCT 19 21:29:20.694709    2008 OCT 19 22:53:34.442728
C          2008 NOV 04 20:15:38.652650    2008 NOV 05 00:18:59.130645
C          2008 NOV 20 19:38:59.674043    2008 NOV 21 00:35:26.726756
C          2008 DEC 06 18:58:34.093679    2008 DEC 07 00:16:17.653066
C          2008 DEC 22 18:02:46.308375    2008 DEC 22 23:26:52.721881
C
...
C         Result window start, stop times (TDB):
C          2008 OCT 19 20:44:30.377189    2008 OCT 19 21:29:20.694709
C          2008 OCT 19 22:53:34.442728    2008 OCT 19 23:38:26.219865
C          2008 NOV 04 19:54:40.368045    2008 NOV 04 20:15:38.652650
C          2008 NOV 05 00:18:59.130645    2008 NOV 05 00:39:58.607159
C          2008 NOV 20 19:21:46.714396    2008 NOV 20 19:38:59.674043
C          2008 NOV 21 00:35:26.726756    2008 NOV 21 00:52:40.606954
C          2008 DEC 06 18:42:36.120122    2008 DEC 06 18:58:34.093679
C          2008 DEC 07 00:16:17.653066    2008 DEC 07 00:32:16.331199
C          2008 DEC 22 17:47:10.796147    2008 DEC 22 18:02:46.308375
C          2008 DEC 22 23:26:52.721881    2008 DEC 22 23:42:28.860689
C
C        Condition: PARTIAL occultation of TITAN by SATURN
C         Result window start, stop times (TDB):
C          2008 OCT 27 21:37:17.003993    2008 OCT 27 22:08:01.672540
C          2008 OCT 28 01:05:03.332576    2008 OCT 28 01:35:49.235670
C          2008 NOV 12 21:01:47.121213    2008 NOV 12 21:21:59.270691
C          2008 NOV 13 02:06:05.034713    2008 NOV 13 02:26:18.211753
C          2008 NOV 28 20:31:28.534248    2008 NOV 28 20:49:02.415745
C          2008 NOV 29 02:13:58.978004    2008 NOV 29 02:31:33.684575
C          2008 DEC 14 19:48:27.106157    2008 DEC 14 20:05:09.258916
C          2008 DEC 15 01:44:53.517960    2008 DEC 15 02:01:36.356012
C          2008 DEC 30 18:44:23.495003    2008 DEC 30 19:00:56.586894
C          2008 DEC 31 00:42:43.219311    2008 DEC 31 00:59:17.027816
C
C        Condition: ANY occultation of SATURN by TITAN
C         Result window start, stop times (TDB):
C          2008 OCT 19 20:44:30.377189    2008 OCT 19 23:38:26.219865
C          2008 NOV 04 19:54:40.368045    2008 NOV 05 00:39:58.607159
C          2008 NOV 20 19:21:46.714396    2008 NOV 21 00:52:40.606954
C          2008 DEC 06 18:42:36.120122    2008 DEC 07 00:32:16.331199
C          2008 DEC 22 17:47:10.796147    2008 DEC 22 23:42:28.860689
C
C        Condition: ANY occultation of TITAN by SATURN
C         Result window start, stop times (TDB):
C          2008 OCT 27 21:37:17.003993    2008 OCT 28 01:35:49.235670
C          2008 NOV 12 21:01:47.121213    2008 NOV 13 02:26:18.211753
C          2008 NOV 28 20:31:28.534248    2008 NOV 29 02:31:33.684575
C          2008 DEC 14 19:48:27.106157    2008 DEC 15 02:01:36.356012
C          2008 DEC 30 18:44:23.495003    2008 DEC 31 00:59:17.027816
C
C
C     3) Find occultations of the Mars Reconnaissance Orbiter (MRO)
...
C$ Restrictions
C
C     1)  The kernel files to be used by GFOCLT must be loaded (normally
...
C$ Version
C
C-    SPICELIB Version 2.0.1, 25-NOV-2021 (JDR) (NJB)
C
C        Edited the header to comply with NAIF standard.
C
C        Modified code example #2 output to comply with maximum line
C        length of header comments. Added SAVE statements for CNFINE and
C        RESULT variables in code examples.
C
C        The $Exceptions section now lists the case of the combination
C        of DSK and non-point target shapes.
C
