...
C$ Version
C
C-    SPICELIB Version 3.2.1, 03-OCT-2021 (NJB)
C
...
C$ Version
C
C-    SPICELIB Version 1.0.1, 03-OCT-2021 (NJB)
C
C        Corrected typos in comments.
C
...
C         SPICE(INVALIDADDRESS) is signaled.
C
...
C$ Version
C
C-    SPICELIB Version 2.0.1, 03-OCT-2021 (NJB)
C
C        Corrected typos in comments.
C
...
C         scratch area, the error SPICE(INVALIDADDRESS) is signaled.
C
C     2)  If END < BEG, this routine simply returns.  No error
C         is signaled.
C
