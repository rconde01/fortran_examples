...
C
C     N        is the number of comments in BUFFER that are to be
...
C
C        Added IMPLICIT NONE standard.
C
C        Edited the header to comply with NAIF standard. Removed
C        unnecessary $Revisions section and fixed the first two entry
C        version lines (Beta -> SPICELIB).
C
C-    SPICELIB Version 1.1.0, 05-FEB-2015 (NJB) (KRG)
C
C        Updated to use ZZDDHHLU.
C
C-    SPICELIB Version 1.0.1, 12-MAY-1994 (KRG)
C
