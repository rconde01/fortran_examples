...
C         coordinates have not been loaded prior to calling SUBPT, an
...
C         have not been loaded prior to calling SUBPT, an error is
C         signaled by a routine in the call tree of this routine.
C
C$ Files
C
...
C        integer IDs for TARGET and OBSRVR.
C
