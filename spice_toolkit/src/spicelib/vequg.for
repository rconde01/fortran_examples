...
C     --------  ---  --------------------------------------------------
C     VIN        I   Double precision n-dimensional vector.
C     NDIM       I   Dimension of VIN (and also VOUT).
C     VOUT       O   Double precision n-dimensional vector set equal
C                    to VIN.
C
C$ Detailed_Input
C
C     VIN      is an arbitrary, double precision n-dimensional vector.
C
C     NDIM     is the dimension of VIN and VOUT.
C
C$ Detailed_Output
C
C     VOUT     is a double precision n-dimensional vector set equal
C              to VIN.
C
C$ Parameters
C
