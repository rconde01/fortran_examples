...
C$ Exceptions
C
C     1) If any of the INQUIRE statements this routine performs fail,
...
C$ Version
C
C-    SPICELIB Version 3.0.1, 02-OCT-2021 (NJB)
C
...
C     systems consider non-existent files as open.  Compensate for
...
C     set FOUND to false and HANDLE to 0 as non-existent files
