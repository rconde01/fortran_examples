...
C$ Detailed_Input
C
C     ANGLE    is the angle, given in radians, through which the
C              rotation is performed.
C
...
C$ Detailed_Output
C
C     MOUT     is the rotation matrix which describes the rotation of
C              a reference frame through ANGLE radians about the axis
C              whose index is IAXIS.
C
C$ Parameters
C
C     None.
