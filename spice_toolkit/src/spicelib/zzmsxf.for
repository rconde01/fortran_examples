...
C
C        Reordered header sections. Corrected typo in comments.
C
...
C
     ...
     .                        + MATRIX(J,6,2)*MATRIX(6,K,1)
         ...
         END DO
C
C        We don't bother to compute the upper right hand 3x3 portion
...
C
         ...
         DO I = 3, N-1
C
C           First the upper left hand portion of the product.
C
            DO J = 1,3
               DO K = 1,3
