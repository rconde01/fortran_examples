...
C     --------  ---  --------------------------------------------------
C     ELIN       I   A SPICE ellipse to be projected.
C     PLANE      I   A plane onto which ELIN is to be projected.
C     ELOUT      O   A SPICE ellipse resulting from the projection.
C
C$ Detailed_Input
C
C     ELIN,
C     PLANE    are, respectively, a SPICE ellipse and a
C              SPICE plane. The geometric ellipse represented
C              by ELIN is to be orthogonally projected onto the
C              geometric plane represented by PLANE.
C
C$ Detailed_Output
C
C     ELOUT    is a SPICE ellipse that represents the geometric
...
C$ Exceptions
C
C     1)  If the input plane is invalid, an error is signaled by a
