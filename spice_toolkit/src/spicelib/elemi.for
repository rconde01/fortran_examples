...
C
C     1) Check if the elements of a list of integers belong to a given
C        integer set.
C
C
...
C              DO I = 1, LISTSZ
C
C                 IF ( ELEMI ( ITEMS(I), A ) ) THEN
C
C                    WRITE(*,'(A,I4,A)') 'Item ', ITEMS(I),
C             .                          ' is in the set.'
C
C                 ELSE
C
...
C
C
C        Item    6 is NOT in the set.
C        Item   -1 is in the set.
C        Item    0 is in the set.
C        Item    2 is NOT in the set.
C        Item    3 is in the set.
C        Item   -2 is NOT in the set.
C
C
C$ Restrictions
