...
C
C     The function returns the product of the elements of ARRAY.
C
C$ Detailed_Input
C
...
C$ Detailed_Output
C
C     The function returns the product of the elements of the input
C     array. That is,
C
...
C$ Restrictions
C
C     1)  PRODAI does not check for overflow. (For integers, this can
