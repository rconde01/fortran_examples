...
C              in the text file.
C
C     N        is the number of data items, characters, to be encoded
C              and written to the text file attached to UNIT.
C
C     DATA     is the list of characters to be encoded and written to
...
C         to unit UNIT, the error SPICE(FILEWRITEFAILED) is signaled.
C
...
C$ Version
C
C-    SPICELIB Version 1.30.0, 28-NOV-2021 (BVS)
C
C        Updated for MAC-OSX-M1-64BIT-CLANG_C.
C
C-    SPICELIB Version 1.29.0, 03-JUN-2021 (JDR)
C
