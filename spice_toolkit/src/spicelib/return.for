...
C$ Abstract
C
C     Return .TRUE. if SPICELIB routines should return immediately upon
C     entry.
C
C$ Disclaimer
C
...
C$ Restrictions
C
C     1)  This routine has no effect unless the error action is
C         'RETURN'!
C
...
C$ Version
C
C-    SPICELIB Version 2.1.1, 26-OCT-2021 (JDR)
C
