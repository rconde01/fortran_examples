...
C$ Version
C
C-    SPICELIB Version 1.7.0, 08-NOV-2020 (EDW)
C
C        Added 'Z' to list of recognized tokens, marked as 
C        no op.
C
...
C$ Version
C
C-    SPICELIB Version 1.3.0, 03-SEP-2020 (EDW)
C
C        Added 'Z' to list of recognized tokens, marked as 
C        no op.
C
...
C
     ...
     .                                                  ERROR, ZZTOKNS )
                  ...
                  ELSE IF ( CLASS(I) .EQ. 'x' ) THEN

C
C                    Recognized token, but ignored.
C
