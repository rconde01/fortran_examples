...
C$ Detailed_Input
C
C     NAME     is the name of the PCK file to be created.
C
C     IFNAME   is the internal filename for the PCK file that is being
...
C
C     NCOMCH   is the space, measured in characters, to be
...
C$ Detailed_Output
C
C     HANDLE   is the handle of the opened PCK file. If an error occurs
...
C        C
C              CHARACTER*(*)         FNAME
C              PARAMETER           ( FNAME = 'pckopn_ex1.bpc' )
C
C              INTEGER               BODY
