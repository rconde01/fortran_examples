...
C     error will be signaled by routines called by this routine.
C     Under normal circumstances, no errors will be signaled.
C
C$ Files
C
C     None.
...
C$ Version
C
C-    SPICELIB Version 4.0.1, 03-OCT-2021 (NJB)
C
