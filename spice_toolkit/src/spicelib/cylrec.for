...
C     CLON       I   Angle (radians) of a point from XZ plane
...
C             .                             0.D0, 1.D0,     1.D0,
C             .                             0.D0, 1.4142D0, 1.D0,
C             .                             1.D0, 1.4142D0       /
C
C              DATA                 CLON /  0.D0,   0.D0,  90.D0,
C             .                             0.D0, 180.D0, 270.D0,
C             .                             0.D0,  45.D0,   0.D0,
C             .                            90.D0,  45.D0         /
C
...
C                 RCLON = CLON(I) * RPD()
C
C                 CALL CYLREC( R(I), RCLON, Z(I), RECTAN )
C
...
C
C
C             R       CLON      Z     RECT(1)  RECT(2)  RECT(3)
C          -------  -------  -------  -------  -------  -------
...
C            1.000   90.000    1.000    0.000    1.000    1.000
C            1.414   45.000    1.000    1.000    1.000    1.000
C
C
C$ Restrictions
C
