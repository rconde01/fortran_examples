...
C
C     The function returns the relative difference between two
C     3-dimensional vectors.
C
C$ Detailed_Input
C
C     V1,
C     V2       are two 3-dimensional vectors for which the relative
C              difference is to be computed.
C
C$ Detailed_Output
C
C     The function returns the relative difference between the two input
C     3-dimensional vectors V1 and V2.
C
C     It is defined as:
C
C                          || V1 - V2 ||
...
C
C     VREL assumes values in the range [0,2]. If both V1 and V2 are zero
C     vectors then VREL is defined to be zero.
C
C$ Parameters
C
C     None.
...
C     Error free.
C
C     1)  If both V1 and V2 are zero vectors, then VREL is defined
C         to be zero.
C
C$ Files
C
