...
C                    first record.
C     INITFR     I   Fractional part of begin time of first record.
C
C$ Detailed_Input
C
...
C         the begin time, the error SPICE(BADDESCRTIMES) is signaled.
C
...
C         error SPICE(NONPOSITIVESCALE) is signaled.
C
C$ Files
C
...
C$ Version
C
C-    SPICELIB Version 1.0.1, 05-AUG-2021 (JDR)
C
C        Edited the header to comply with NAIF standard.
C
C        Added missing description of INITFR to $Brief_I/O section.
C
