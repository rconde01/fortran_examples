...
C$ Abstract
C
C     Compute arc cosine of a bracketed argument.
C
...
C     TOL        I   Tolerance.
C
C     The function returns the arc cosine of ARG.
C
C$ Detailed_Input
C
C     ARG      is the arc cosine argument that is to be evaluated such
...
C$ Detailed_Output
C
C     The function returns the arc cosine of ARG. If
C
C        |ARG| >= 1.D0,
C
C     it returns DACOS (1.D0) or DACOS (-1.D0) as appropriate. Values
C     range from 0 to PI.
C
C$ Parameters
C
C     None.
