...
C     set of coordinate pairs, at a specified abscissa value. Return
C     both the value of the polynomial and its derivative.
C
C$ Disclaimer
C
...
C
C     WORK     is an N * 2 work space array, where N is the same
...
C
C        The returned value of P should be 1.0, since the
C        unique cubic polynomial that fits these points is
C
C                       3      2
C           F(X)   =   X  + 2*X  - 4*X - 7
C
C        The returned value of DP should be 16.0, since the
...
C
C
C         P, DP =    1.0000000000000000        16.000000000000000
C
C
C$ Restrictions
C
...
C        "IMPLICIT NONE" to code example.
C
