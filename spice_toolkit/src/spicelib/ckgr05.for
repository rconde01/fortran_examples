...
C$ Abstract
C
C     Return a specified pointing instance from a CK type 05 segment.
...
C
C        Bug fix: added FAILED tests after all DAFGDA calls but the
C        last.
C
C        Added explicit conversion to INTEGER for SUBTYP.
C
