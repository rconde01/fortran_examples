...
C$ Version
C
C-    SPICELIB Version 1.1.0, 12-OCT-2020 (JDR) (BVS)
C
C        Changed entry point ZZHSCINI to not check RETURN()
...
C$ Version
C
C-    SPICELIB Version 1.1.0, 12-OCT-2020 (BVS)
C
C        Changed to not check RETURN() on entry. The entry point 
C        now initializes the hash as long as the size parameter 
