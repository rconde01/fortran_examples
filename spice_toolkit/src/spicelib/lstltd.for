...
C     a given number X in an array of non-decreasing numbers.
C
C$ Disclaimer
C
...
C              element of ARRAY that is the greatest element less than X
C              is to be found.
C
...
C           2
C
C     steps to compute the value of LSTLTD.
C
