...
C              SPICE(BADSTDIONAME) is signaled and UNIT is
C              set to -100.
C
C$ Detailed_Output
C
...
C$ Version
C
C-    SPICELIB Version 1.0.1, 20-AUG-2021 (JDR)
C
C        Edited the header to comply with NAIF standard. Spelled out I/O
C        in $Keywords section.
C
