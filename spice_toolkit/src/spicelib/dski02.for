...
C              VALUES with the elements of the data item is:
C
...
C
C        C
C        C     For the first 5 plates, look up the desired data.
C        C
C              K = MIN(5, NP)
C              DO I = 1, K
C        C
...
C        $Keywords section. Modified code example to reduce the output.
C
