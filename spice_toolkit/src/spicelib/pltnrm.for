...
C
C              WRITE (*, '(A,3F18.14)' ) 'NORMAL = ', NORMAL
C
C              END
C
C
...
C
C
C        NORMAL =   0.00000000000000  0.00000000000000  2.59807621135332
C
C
C$ Restrictions
C
...
C        Changed code example output format for the solution to fit
