...
C$ Version
C
C-    SPICELIB Version 1.1.0, 20-NOV-2020 (NJB)
C
C        Bug fix: in call to ZZADDLNK, size of pointer array was
C        changed from NP to NV.
C
...
C
            CALL ZZADDLNK ( PLATES(J,I), I,     NV,   CELLSZ,
     .                      VRTPTR,      NCELL, CELLS        )
