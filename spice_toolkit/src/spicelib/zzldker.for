...
C$ Version
C
C-    SPICELIB Version 2.1.0, 17-OCT-2021 (BVS)
C
C        Wrapped KERLIN and TERMIN declarations in FORTRAN environment
C        block to silence declared-not-used complaints from f2c.
C
