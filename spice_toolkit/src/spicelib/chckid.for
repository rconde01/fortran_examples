...
C         MAXLEN, the error SPICE(IDSTRINGTOOLONG) is signaled.
C
...
C         case.
C
C     6)  The error messages output by this routine have a maximum
...
C
C     The error message signaled by this routine contains the offending
