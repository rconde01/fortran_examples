...
C$ Abstract
C
C     Return the number of pointing instances in a CK type 01 segment.
...
C              CKLPF or DAFOPR.
C
C     DESCR    is the packed descriptor of a data type 1 segment.
C
C$ Detailed_Output
C
C     NREC     is the number of pointing records in the type 1 segment.
C
C$ Parameters
C
C     None.
...
C         passed to this routine must be opened for read access by
C         either CKLPF or DAFOPR.
C
