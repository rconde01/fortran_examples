...
C$ Abstract
C
C     Find a given identifier, which consists of an integer array,
C     within a list of such identifiers, or insert the identifier
C     into the list. Return the location of the identifier and a flag
C     indicating whether or not the identifier was already present.
C
C$ Disclaimer
C
...
C     POOL      I-O  A doubly linked list used for search LIST.
C     AT        I-O  Location of the ID in the LIST.
C     PRESNT     O   Flag indicating if ID was already in LIST.
C
C$ Detailed_Input
C
...
C         error SPICE(ADDRESSOUTOFBOUNDS) is signaled.
C
...
C        PRESNT short description in $Brief_I/O section.
C
