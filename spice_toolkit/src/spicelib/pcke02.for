...
C$ Detailed_Output
C
C     EULANG   is the Euler angles and their derivatives at
C              time ET.
C
C$ Parameters
C
...
C     calls the routine SPKE02 for each set to evaluate the polynomial
...
C        taken directly from the segment. As such, it will be
