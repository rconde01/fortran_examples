...
C$ Restrictions
C
C     1)  The array must be large enough to contain both the original
...
C         not in the interval [1, NA+1], an error is signaled.
...
C         to insert is 1. If it is not 1, an error is signaled
