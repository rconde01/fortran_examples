...
C$ Detailed_Input
C
C     LEFT     is the amount to be subtracted from the left endpoint of
C              each interval in the input window. The amount LEFT is
C              signed.
C
C     RIGHT    is the amount to be added to the right endpoint of each
C              interval in the window. The amount RIGHT is signed.
C
