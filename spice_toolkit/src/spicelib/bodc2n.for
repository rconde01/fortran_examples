...
C              The current value of this parameter is 36. See
C              the SPICELIB include file zzbodtrn.inc for details.
C
C$ Exceptions
C
...
C        description of MAXL parameter and added $Exceptions,
C        $Restrictions and $Files.
C
