...
C$ Abstract
C
C     Indicate for a specified body whether planetographic and
C     planetocentric longitude increase in the same sense.
C
C$ Disclaimer
C
...
C     --------  ---  --------------------------------------------------
C     BODID      I   is the NAIF integer ID code of some solar system
C                    object.
C
C     The function returns 1 if planetographic and planetocentric
C     longitude for the specified body increase in the same sense, and
C     -1 if they increase in the opposite sense.
C
C$ Detailed_Input
C
...
C
C     The function returns 1 if planetographic and planetocentric
C     longitude increase in the same sense for the input body, and
C     -1 if they increase in the opposite sense. Planetocentric
C     longitude always increases in the counterclockwise direction
C     about the +Z axis of the body-fixed, body-centered reference
C     frame of the specified body.
C
C     The sense in which planetographic longitude increases for the
C     body specified by BODID is based upon loaded PCK values in
C     the kernel pool.
C
C     If PCK information for the specified body can not be located in
C     the kernel pool, the function returns the value 0.
C
C$ Parameters
C
C     None.
...
C$ Version
C
C-    SPICELIB Version 1.0.2, 26-OCT-2021 (JDR)
C
...
C        sections.
C
C-    SPICELIB Version 1.0.0, 07-JAN-1997 (WLT)
C
C-&
