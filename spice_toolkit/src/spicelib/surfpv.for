...
C$ Exceptions
C
C     1)  If the input ray's direction vector is the zero vector, an
C         error is signaled by a routine in the call tree of this
C         routine.
C
C     2)  If any of the ellipsoid's axis lengths is nonpositive, an
C         error is signaled by a routine in the call tree of this
C         routine.
C
C     3)  If the vertex of the ray is on the ellipsoid, the error
C         SPICE(INVALIDVERTEX) is signaled.
C
C$ Files
C
C     None.
...
C
C
C              PROGRAM SURFPV_EX1
C              IMPLICIT NONE
C
C              CHARACTER*(*)         F1
C              PARAMETER           ( F1 = '(A,3E20.12)' )
C
...
C
C              WRITE (*,*) ' '
C              WRITE (*,*) 'Case 1: Vertex varies, direction '
C             .         // 'is constant'
C              WRITE (*,*) ' '
C
C              STVRTX( 1 ) =  2.D0
...
C
C         Ellipsoid radii:
C              A =    1.0000000000000000
C              B =    2.0000000000000000
C              C =    3.0000000000000000
C
C         Case 1: Vertex varies, direction is constant
C
C         Vertex:
C           0.200000000000E+01  0.000000000000E+00  0.000000000000E+00
C         Vertex velocity:
C           0.000000000000E+00  0.000000000000E+00  0.300000000000E+01
C         Direction:
C          -0.100000000000E+01  0.000000000000E+00  0.000000000000E+00
...
C          -0.100000000000E+01  0.000000000000E+00  0.000000000000E+00
C         Direction velocity:
C           0.000000000000E+00  0.000000000000E+00  0.400000000000E+01
C         Intercept:
C           0.100000000000E+01  0.000000000000E+00  0.000000000000E+00
C         Intercept velocity:
C           0.000000000000E+00  0.000000000000E+00  0.700000000000E+01
C
C
...
C
C         Vertex:
C           0.200000000000E+01  0.000000000000E+00  0.300000000000E+01
C         Vertex velocity:
C           0.000000000000E+00  0.000000000000E+00  0.100000000000+300
C         Direction:
C          -0.100000000000E+01  0.000000000000E+00  0.000000000000E+00
C         Direction velocity:
C           0.000000000000E+00  0.000000000000E+00  0.100000000000+300
C         Intercept:
C           0.258095682795E-07  0.000000000000E+00  0.300000000000E+01
C         Intercept velocity:
C          -0.387453203621+307  0.000000000000E+00  0.299999997419+300
C
C
C$ Restrictions
C
...
C$ Version
C
C-    SPICELIB Version 1.0.1, 22-JUL-2020 (JDR)
C
C        Edited the header to comply with NAIF standard.
C
C        Reformatted example's output to comply with maximum line
C        length for header comments.
C
