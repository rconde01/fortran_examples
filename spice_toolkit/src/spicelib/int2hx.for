...
C$ Detailed_Input
C
C     NUMBER   is the integer to be converted.
C
C$ Detailed_Output
C
C     STRING   is the signed hexadecimal string representing the integer
C              NUMBER.
C
...
C
C     LENGTH   is the length of the hexadecimal character string
C              produced by the conversion.
C
C$ Parameters
C
C     None.
...
C         string is specified by the local parameter STRLEN.
C
