...
C$ Abstract
C
C     Reorder the elements of a logical array according to a given order
C     vector.
C
C$ Disclaimer
C
...
C     Error free.
C
C     1)  If NDIM < 2, this routine executes a no-op. This case is
C         not an error.
C
C$ Files
C
...
C        code example.
C
C        Added entry #1 in $Exceptions section.
C
C-    SPICELIB Version 1.0.0, 06-MAR-1996 (WLT) (IMU)
C
C-&
