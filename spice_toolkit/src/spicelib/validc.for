...
C$ Exceptions
C
C     1)  If the size of the set is too small to hold the set BEFORE
C         validation, the error SPICE(INVALIDSIZE) is signaled. The set
C         A is not modified.
C
C$ Files
C
...
C$ Version
C
C-    SPICELIB Version 1.1.0, 05-AUG-2021 (JDR)
C
