...
C          Section 8.3, pp.8-6, September 1984.
C
C     [2]  "Microsoft FORTRAN Reference", Microsoft Corporation,
C          Section 5.1.1, p.241, 1989.
C
C     [3]  "Language Systems FORTRAN Reference Manual", Language Systems
C          Corporation, version 1.2.1, pp.3-20.
C
C     [4]  "Lahey F77L EM/32 FORTRAN Language Reference Manual", p.222,
C          Note 20.
C
...
C
C-    SPICELIB Version 2.26.1, 12-AUG-2021 (JDR)
C
