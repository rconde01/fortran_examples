...
C$ Detailed_Output
C
C     OUTSTR   is the input string after it has been cycled.
C
C$ Parameters
C
C     None.
...
C$ Restrictions
C
C     1)  The memory used for the output string must be identical to
C         that used for the input string or be disjoint from the input
C         string memory.
C
C         That is:
C
...
C$ Version
C
C-    SPICELIB Version 1.2.0, 12-AUG-2021 (JDR)
C
