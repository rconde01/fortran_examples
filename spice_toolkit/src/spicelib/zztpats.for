...
C
C     The lengths of the strings assigned to an arbitrary MYKNWN
C     element must equal the string lengths of the corresponding
C     element MYMNNG. The relation, one-to-one and onto,
C     defining the meaning (or non meaning) and type of each
C     symbol in the time string abstract representation.
C
C$ Examples
C
C     See TPARTV
...
C$ Version
C
C-    SPICELIB Version 3.2.0, 01-OCT-2020 (EDW) (NJB) (BVS)
C
C        Implemented a FIRST block to prevent reinitialization
C        of patterns on each entry to routine.
C
C        Added patterns to accommodate ISO formats with 'Z' suffix.
C
...
C
C        ISO patterns allowing the 'Z' suffix, only a suffix.
C
         MYKNWN( 204 ) = 'Y-i-itx'
         MYMNNG( 204 ) = 'Y*m*D**'


         MYKNWN( 205 ) = 'Y-i-iti:ix'
         MYMNNG( 205 ) = 'Y*m*D*H*M*'


         MYKNWN( 206 ) = 'Y-i-iti:i:ix'
         MYMNNG( 206 ) = 'Y*m*D*H*M*S*'


         MYKNWN( 207 ) = 'Y-i-iti:i:nx'
         MYMNNG( 207 ) = 'Y*m*D*H*M*S*'


         MYKNWN( 208 ) = 'Y-i-iti:nx'
         MYMNNG( 208 ) = 'Y*m*D*H*M*'
         ...
         MYKNWN( 211 ) = 'Y-iti:i:ix'
         MYMNNG( 211 ) = 'Y*y*H*M*S*'


         MYKNWN( 212 ) = 'Y-iti:i:nx'
         MYMNNG( 212 ) = 'Y*y*H*M*S*'
         ...
         MYKNWN( 215 ) = 'i-i-iti:ix'
         MYMNNG( 215 ) = 'Y*m*D*H*M*'


         MYKNWN( 216 ) = 'i-i-iti:i:ix'
         MYMNNG( 216 ) = 'Y*m*D*H*M*S*'


         MYKNWN( 217 ) = 'i-i-iti:i:nx'
         MYMNNG( 217 ) = 'Y*m*D*H*M*S*'


         MYKNWN( 218 ) = 'i-i-iti:nx'
         MYMNNG( 218 ) = 'Y*m*D*H*M*'
         ...
         MYKNWN( 221 ) = 'i-iti:i:ix'
         MYMNNG( 221 ) = 'Y*y*H*M*S*'


         MYKNWN( 222 ) = 'i-iti:i:nx'
         MYMNNG( 222 ) = 'Y*y*H*M*S*'
