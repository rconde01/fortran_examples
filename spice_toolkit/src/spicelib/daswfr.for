...
C         open DAS file, an error is signaled by a routine in the call
C         tree of this routine.
C
C     2)  If the specified DAS file is not open for write access, an
...
C$ Version
C
C-    SPICELIB Version 3.1.1, 02-JUN-2021 (JDR)
C
