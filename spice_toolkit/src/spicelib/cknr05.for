...
C$ Abstract
C
C     Return the number of pointing instances in a CK type 05 segment.
...
C              segment.
C
C     DESCR    is the packed descriptor of a data type 5 segment.
C
C$ Detailed_Output
C
C     NREC     is the number of pointing instances in the type 5
C              segment.
C
C$ Parameters
C
