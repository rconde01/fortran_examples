...
C              defined by XVALS. The elements
C
C                 YVALS( 2*I - 1 )
C                 YVALS( 2*I     )
C
...
C
C        The returned value should be 141.0, and the returned
C        derivative value should be 456.0, since the unique 7th degree
...
C              YVALS(8)  =  109395.D0
C
C              CALL HRMINT ( N, XVALS, YVALS, 2.D0, WORK, ANSWER,
C             .                                           DERIV )
C
...
C$ Version
C
C-    SPICELIB Version 1.2.2, 01-OCT-2021 (NJB) (JDR)
C
C        Edited the header to comply with NAIF standard. Fixed
C        a few more comment typos. Added IMPLICIT NONE to code
C        example.
C
