...
C              table.
C
C              If the symbol does not exist, the symbol table remains
C              unchanged. This subroutine is case sensitive, NAME must
C              match the symbol exactly.
C
C     TABSYM,
C     TABPTR,
C     TABVAL   are the components of a double precision symbol table.
C
C              On input, the table may or may not contain the symbol
C              NAME.
C
C$ Detailed_Output
C
...
C     TABVAL   are the components of a double precision symbol table.
C
C              On output, the symbol table no longer contains the symbol
C              NAME or its associated values. If NAME is not a symbol,
C              the components of the symbol table remain unchanged.
C
C$ Parameters
C
C     None.
