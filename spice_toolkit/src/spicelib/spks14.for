...
C$ Detailed_Input
C
C     SRCHAN   is the handle of the SPK file containing the source
C              segment.
C
C     SRCDSC   is the SPK descriptor for the source segment.
C
C     DSTHAN   is the handle of the SPK file containing the new segment.
C
C     DSTDSC   is the SPK descriptor for the destination segment. It
C              contains the desired start and stop times for the
C              requested subset.
C
C     DSTSID   is the segment identifier for the destination segment.
C
C$ Detailed_Output
C
C     None.
...
C         than MAXREC, the error SPICE(SPKRECTOOLARGE) is signaled.
C
C$ Files
C
