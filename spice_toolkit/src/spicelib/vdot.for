...
C
C     1) Suppose that you have a set of double precision 3-dimensional
C        vectors. Check if they are orthogonal to the Z-axis.
C
C
...
C             .                         ( V1(J,I), J=1,3 )
C
C                 IF ( VDOT( V1(1,I), Z ) .EQ. 0.D0 ) THEN
C
...
C
C
C        Input vector (V1):    1.0   0.0   0.0
C        V1 and Z are orthogonal.
C
C        Input vector (V1):    0.0  -6.0   0.0
C        V1 and Z are orthogonal.
C
C        Input vector (V1):   10.0   0.0  -1.0
C        V1 and Z are NOT orthogonal.
C
C        Input vector (V1):    0.0   0.0   1.0
C        V1 and Z are NOT orthogonal.
C
C
C$ Restrictions
