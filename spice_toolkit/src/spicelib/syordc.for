...
C     TABVAL   are the components of a character symbol table.
C
C              On output, the components of the symbol are sorted
C              according to ASCII collating sequence. If NAME is not in
C              the symbol table, the symbol table is not modified.
C
C$ Parameters
C
C     None.
