...
C        named 'ekacld_ex1.bes' which contains records of orders for
...
C
C
C        The file "ekacld_ex1.bdb" will contain two segments, the first
...
C
C              CALL EKOPN ( 'ekacld_ex1.bes', IFNAME, NRESVC, HANDLE )
C
C        C
