...
C$ Abstract
C
C     Return .TRUE. if two given double precision numbers have the same
C     sign.
C
C$ Disclaimer
C
...
C
C     The function returns .TRUE. if the input arguments have the same
C     sign.
C
C$ Detailed_Input
C
...
C$ Detailed_Output
C
C     The function returns .TRUE. if X and Y are both positive or both
C     negative. Otherwise, it returns .FALSE.
C
C$ Parameters
C
C     None.
