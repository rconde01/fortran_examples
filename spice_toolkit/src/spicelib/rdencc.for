...
C              in the text file.
C
C     N        is the number of characters to be read from the text file
C              attached to UNIT.
C
C$ Detailed_Output
C
C     DATA     is the list of characters which were read from the text
C              file attached to UNIT and decoded.
C
C$ Parameters
C
C     None.
