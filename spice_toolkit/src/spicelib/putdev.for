...
C$ Detailed_Input
C
C     DEVICE   is the new value of the error output device
...
C
C-    SPICELIB Version 2.1.0, 05-JAN-1995 (HAN)
C
...
C$ Index_Entries
C
C     store the error output device specification
C
C-&
...
C$ Index_Entries
C
C     get current error output device specification
C
C-&
