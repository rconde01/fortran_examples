...
C     (attached to HANDLE) for all segments applicable to the Voyager 2
C     wide angle camera, for a particular spacecraft clock time, that
C     are of data types 1 or 2. It then evaluates the pointing for that
...
C$ Version
C
C-    SPICELIB Version 1.1.2, 06-JUL-2021 (NJB) (JDR)
C
