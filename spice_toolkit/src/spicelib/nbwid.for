...
C
C     The function returns the index of the rightmost non-blank
...
C     value of LASTNB for the array, but somewhat more efficient to
C     compute. If NELT is not greater than zero, NBWID is zero.
C
C$ Parameters
C
C     None.
