...
C$ Version
C
C-    Beta Version 2.28.0, 28-NOV-2021 (BVS)
C
...
C     VAX:
C
C        Computer:         VAX 11/780
C        Operating System: VAX VMS 5.3
C        Fortran:          VAX FORTRAN 5.5
C
C
C     PC-MS:
C
C        Computer:         PC
C        Operating System: Microsoft DOS 5.00
C        Fortran:          Microsoft Powerstation Fortran V1.0
C
C
