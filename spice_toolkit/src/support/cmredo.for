...
C$ Detailed_Output
C
C     TRAP       is a logical indicating whether the string was special
...
C$ Version
C
C-    SPICELIB Version 2.0.1, 06-DEC-2021 (BVS)
C
C        Filled in $Index_Entries, cleaning up non-printing characters.
C
