...
C          COMLOOP(NOFILECREATION) will be signaled.
C
...
C        that should be edited.  This is the only option available
...
C
C        Fixed the bug that occurred if you typed RECALL x and
