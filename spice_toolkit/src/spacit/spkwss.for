...
C$ Version
C
C-    SPACIT Version 4.1.0, 31-AUG-2021 (BVS)
C
C        Removed '(Short Period)' from Type 10 description.
C
C        Replaced Type 11 description with 'Type 11', similar 
C        to also non-existing Type 6.
C
